    ...
    <div style={{ width: '100%', zIndex: 99999, position: 'sticky', top: 0 }} className="bg-red-600 text-white shadow-2xl">
      <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-3 text-center sm:text-left">
        <div className="flex-1 flex flex-col sm:flex-row items-center gap-2 justify-center sm:justify-start">
          <strong className="font-black uppercase tracking-wider text-xs sm:text-sm bg-red-700 px-2 py-0.5 rounded border border-red-500">
            PROMO B2B EXCLUSIVE :
          </strong>
        ...
        <div className="flex items-center gap-3 shrink-0">
          <a 
            href="/devis" 
            className="bg-white text-red-600 hover:bg-slate-100 px-4 py-1.5 rounded-xl text-xs font-black uppercase tracking-wider transition-all shadow-md"
          >
            Demander un devis
          </a>
          ...
          <button
            ...
            className="p-1 rounded-full hover:bg-red-700/80 text-white/90 hover:text-white transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
